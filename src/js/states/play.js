...
StatePlay.prototype.init = function () {
    ...
    // get settings button dom
    this.dom.sound = g.qS('.b-sound');
    this.dom.credits = g.qS('.b-credits');
    // get ui button dom
    ...
    g.on(this.dom.credits, 'click', this.onCreditsClick, this);
    g.on(this.dom.sound, 'click', this.onSoundClick, this);
...
StatePlay.prototype.onSoundClick = function () {
    g.settings.mute = !g.settings.mute;
    if (!g.settings.mute) {
        g.removeClass(this.dom.sound, 'active');
    } else {
        g.addClass(this.dom.sound, 'active');
    }
};

StatePlay.prototype.onCreditsClick = function () {
    alert('TODO'); 
};
