...
<html>
    ...
    <body>
            ...
            <div class="s s-play">
                ...
                <div class="row top-row">
                    <div class="game-title">
                        Elematter <a class="b-credits">by Jack Rugile for js13kGames</a> 
                    </div>
                    <a class="b b-play s5"><i>&rtrif;</i>Play</a>
                    <a class="b b-sound s1">&#9835;</a> 
                ...
                <div class="row bot-row">
                    ...
                    <a class="b b-send s5"><i>&raquo;</i>Send Next wave +<span class="send"> </span> <i>&there4;</i></a>
                </div>
                <!--==============================================================================
        ...
        <?php } else { ?>
            ...
            <script src="js/g/settings.js"></script>
